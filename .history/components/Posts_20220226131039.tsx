...
const Posts: React.FC<Props> = ({ posts }) => {
  return (
    <div className="mx-auto my-4 flex max-w-screen-xl flex-col items-center gap-5 md:grid md:grid-cols-2 md:place-content-center md:gap-3 lg:grid-cols-3 lg:gap-6">
      {posts.map((post) => (
