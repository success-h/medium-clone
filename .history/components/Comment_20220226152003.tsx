  ...
  return (
    <div className="mx-auto my-10 max-w-2xl">
      <div className="mx-5 sm:mx-0">
        ...
        <h2 className="text-lg text-sky-500">Enjoyed the article?</h2>
        ...
        {submitted ? (
          ...
          >
            ...
            <input className="focus:shadow-outline cursor-pointer rounded bg-sky-900 py-4 font-semibold text-white hover:bg-green-400 focus:outline-none" />
          </form>
        )}
      </div>
