...
const Posts: React.FC<Props> = ({ posts }) => {
  return (
    <div className="mx-auto my-4 flex max-w-xl flex-col items-center gap-5 overflow-hidden md:grid md:grid-cols-2 md:place-items-center md:gap-3 lg:grid-cols-3 lg:gap-6">
      {posts.map((post) => (
